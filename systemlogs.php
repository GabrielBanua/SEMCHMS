...
$userlogs = "SELECT * FROM login_logs";
$Query = mysql_query($userlogs);
              ...
              <ul class="sidebar-menu" id="nav-accordion">
				  ...
				  <li class="sub-menu" id="Maintenance-li">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="systemlogs.php">System Logs</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
                          ...
                          <div class="panel-body">
                                <div class="adv-table">
                                    <table  class="table table-striped table-advance table-hover" id="example">
                                      ...
                                      ?>
                                          <tr class="gradeX">
                                            <td class="text-center"><?php echo $row['Date_login']; ?></td>
