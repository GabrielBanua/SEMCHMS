									...
									?>
                                      <tr class="gradeX">
                                          ...
                                          <td class="center hidden-phone">
                                              <a class="btn btn-shadow btn-success btn-xs" <?php if($Position == 'Doctor'){echo "style='display: none;'";}?> style="width:30px" data-toggle="modal" data-target="#EditSched-<?php echo $row['SCHEDULE_ID']?>"><span  class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Edit Schedule"><i class="icon-pencil"></i></span></a>
                                  			  <a class="btn btn-shadow btn-danger btn-xs" <?php if($Position == 'Doctor'){echo "style='display: none;'";}?> style="width:30px" onclick="DeleteSched(<?php echo $row['SCHEDULE_ID']; ?>)"><span  class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Delete Schedule"><i class="icon-trash"></i></span></a>
                                  			  <a class="btn btn-shadow btn-primary btn-xs" <?php if($Position == 'Doctor'){echo "style='width:100px'";}else{echo "style='width:30px'";} ?> href="view-patient-profile.php?VID=<?php echo $row['P_ID']; ?>&Sched_ID=<?php echo $row['SCHEDULE_ID']; ?>"><span  class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Proceed Schedule"><i <?php if($Position == 'Doctor'){}else{ echo "class=' icon-share-alt'";}?>></i></span><?php if($Position == 'Doctor'){echo "Proceed";} ?></a>
