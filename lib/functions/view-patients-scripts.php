<script type="text/javascript" charset="utf-8">
    ...
    function change(str){
        ...
        var P_ID = str;
        var Brgy = $('#P_BRGY-'+str).val();
        var Purok = $('#P_PUROK-'+str).val();
