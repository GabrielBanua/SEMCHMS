                      ...
                      <ul class="sub">
                          <li class="sub-menu">
                              ...
                              <ul class="sub">
								  ...
								  <li class="active"><a href="add-lab-fecal.php">Fecalysis</a></li>
                      ...
                      <section class="panel">
						  ...
						  <div class="panel-body">
								<form class="form-horizontal" role="get">
									...
									<!--Results--><hr>
									<label> MACROSCOPIC EXAMINATION:</label>
								  ...
								  <div class="form-group">
                                      <label class="col-sm-1 control-label">Consistency:</label>
									  <div class="col-sm-3">
										<input type="text" class="form-control">
									  </div>
								  ...
								  <div class="form-group">
                                      <label class="col-sm-1 control-label">Heinths:</label>
									  <div class="col-sm-3">
										<input type="text" class="form-control">
									  </div>
